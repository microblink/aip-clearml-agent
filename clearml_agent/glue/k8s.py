...
class K8sIntegration(Worker):
    ...
    CONTAINER_BASH_SCRIPT = [
        ...
        *(
        ...
        "{extra_bash_init_cmd}",
        "[ ! -z $CLEARML_AGENT_NO_UPDATE ] || $LOCAL_PYTHON -m pip install git+https://github.com/microblink/aip-clearml-agent.git@${{CLEARML_AGENT_BRANCH}}{agent_install_args}",
    ...
    def _delete_completed_or_failed_pods(self, namespace, msg: str = None):
        ...
        if failed_pods and self.log_pod_status_before_deleting:
